...
<html>
    ...
    <body id="">
        <header id="head" style="background-color: #b90112;"> 
            <div class="row"> 
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-7" id="div_lgos">
                    <div class="col-lg-12" >
                        <h1 style="color:whitesmoke; text-align:center; margin-top:10px; font-family: century gothic;">Hotel Management System  </h1>
                    </div>
        ...
        <div id="sect1" class="row" style=" background-color:white; padding-top:20px;">
            ...
            <div class="col-lg-12"><h1 style="text-align:center">Prix des produits</h1></div>
            ...
            <div class="col-lg-10" style="margin-top:30px; padding:20px; border: 2px solid #b90112; background-color:white; border-radius:150px 0px 150px 0px;">
                ...
                <div class="row" style=" padding: 20px;" > 
                    ...
                    <div class="col-lg-4" style="">
                        ...
                        <center title="">
                             <a href="prixNour.php" target="_blank" style="" >
                    ...
                    <div class="col-lg-4" style="">
                         ...
                         <center >
                             <a href="prixBoiss.php" target="_blank" >
                                <img src="../docs/emoticones/boiss2.png" width="40%" alt="nourriture" > </a>
                        </center>
                        <legend style="color:black; text-align:center; border-bottom: 1px solid #b90112">Boisson</legend>
                    </div>                    
                    
                    <div class="col-lg-4" style=" ">
                        
                        <center title="">
                             <a href="prixDiv.php" target="_blank" style="">
                                <img src="../docs/emoticones/cleaning.png" width="40%" alt="Sauna-Gym-Piscine" > </a>
                        </center>
                        <legend style="color:black; text-align:center; border-bottom: 1px solid #b90112">Divers</legend>
                    </div> 
        ...
        <style>
            ...
            <div style="text-align:center; color:black; font-size: 1.5em; font-family: century gothic;">
                    Copyright &copy;<script>document.write(new Date().getFullYear());</script> Tous droits réservés | Ce modèle est fait par <a style="color:blue" href="https://softech-rdc.com" target="_blank">Soft Tech Corporation</a>
                </div>
