<?php
    ...
    $req = $bd->prepare("SELECT  agent,montantSortieBanque,date_format(dateSortieBanque,'%d-%m-%Y') as dateSortieBanque,motifSortieBanque FROM sortieBanque WHERE  dateSortieBanque LIKE '%$dateJ%'");
        $req->execute();
        $req1 = $bd->prepare("SELECT SUM(montantSortieBanque) AS total FROM sortieBanque WHERE dateSortieBanque LIKE '%$dateJ%'");
        $req1->execute();
    ...
    if (isset($_GET['save'])) {
        ...
        $req = $bd->prepare("SELECT  agent,montantSortieBanque,date_format(dateSortieBanque,'%d-%m-%Y') as dateSortieBanque,motifSortieBanque FROM sortieBanque WHERE  dateSortieBanque BETWEEN ? AND ? ");
        $req->execute(array($in,$out));
        $req1 = $bd->prepare("SELECT SUM(montantSortieBanque) AS total FROM sortieBanque WHERE dateSortieBanque BETWEEN ? AND ? ");
            ...
            <div class="row" style="border-bottom:1px solid black;margin-bottom:2px">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8" >
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top:70px;">
                        <h1 class="text-center text-uppercase" style="text-align:center">Fiche de depenses Banque
                    ...
                    <table class="table table-bordered table-striped spacer">
                        ...
                        <tbody>
                                ...
                                <tr>
                                        ...
                                        <td><?php echo $don['dateSortieBanque'] ?></td>
