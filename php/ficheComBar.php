            ...
            <div class="row" style="border-bottom:1px solid black;margin-bottom:2px">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8" >
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top:70px;">
                        <h3 class="text-center text-uppercase" style="text-align:center; border: 1px solid black">Liste de commandes journalières <?php echo $poste; ?> </h3>
                    </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                                ...
                                $req = $bd->query("SELECT * FROM commande AS A ,catboiss AS B , prodboiss AS C WHERE A.idBoiss=C.idBoiss AND C.idCatBoiss=B.idCatBoiss AND dateCom LIKE '%$dateJ%' AND statutCom='Validé' AND A.idPv='$c' ");
                                $num=1;
                            ...
                            $num++;
                             ...
                             <tr>
                                            ...
                                            <td><strong>
                                                <?php 
                                                 $req1=$bd->query("SELECT SUM(C.nbUniteBoiss*C.puBoiss*A.qteCom) as total FROM commande AS A ,catboiss AS B , prodboiss AS C WHERE A.idBoiss=C.idBoiss AND C.idCatBoiss=B.idCatBoiss AND dateCom LIKE '%$dateJ%' AND statutCom='Validé' AND A.idPv='$c'");
