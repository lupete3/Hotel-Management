...
<html>
    ...
    <body id="">
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" >
                   <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 offset-8">
                        <center style="padding-top: 10px;">
                             <a href="../logout_brm.php" title="cliquer pour vous déconnecter"><img src="../../docs/emoticones/exit%20circular.png" width="100%" alt="Front Office" > </a>
                        </center>
                    </div>

                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: 20px;">
                        <span style="text-align: center; color: whitesmoke; font-size: 1.3em;
        ...
        <div id="sect1" class="row" style=" background-color:white; padding-top:20px;">
            ...
            <div class="col-lg-12"><h1 style="font-family: Century gothic; text-align:center">Espace <?php echo $_SESSION['profil']['agent5']['libPv'] ?> </h1></div>
            
            <div class="col-lg-1"></div>
            <div class="col-lg-10" style="margin-top:30px; padding:20px; border: 2px solid #b90112; background-color:white; border-radius:150px 0px 150px 0px; box-shadow: 0px 10px 20px;">
            ...
            <div class="row" style=" padding: 20px;" > 
                <div class="col-lg-12">                  
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3" style="">
                        ...
                        <legend style="color:black; text-align:center; border-bottom: 1px solid #b90112">Point de ventes</legend>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3" style="">
                     ...
                     <div class="col-lg-3 col-md-3 col-sm-3" style="">
                         <center >
                             <a href="../pages/listePlat.php" >
                                <img src="../../docs/emoticones/new/restaur.png" width="40%" alt="nourriture" > </a>
                        </center>
                        <legend style="color:black; text-align:center; border-bottom: 1px solid #b90112">Liste Plats</legend>
                    </div>                   
                </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 " style="">
                        ...
                        <legend style="color:black; text-align:center; border-bottom: 1px solid #b90112">Gestion boissons</legend>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 " style="">
                        <center>
                            <a href="../pages/transfert.php"><img src="../../docs/MAJ/transfer.png" width="40%" alt="Gestion depenses" > </a>
                        </center>
                        <legend style="color:black; text-align:center; border-bottom: 1px solid #b90112">Transfert boissons</legend>
                    </div> 
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="">
                        <center>
                            <a href="../rap_bar.php"><img src="../../docs/emoticones/new/tg.png" width="40%" alt="Rapport" > </a>
                        </center>
