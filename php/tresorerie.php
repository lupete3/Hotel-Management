            ...
            <div class="col-lg-10" style="padding:1%;">
                <div class="row" style="text-align:center;">
                    <div class="col-md-12 text-center text-uppercase">
                        <h1 style="color:black;  " class="text-center">Rapport tresorerie </h1>
                    </div>
                </div>
                ...
                <div class="container" style="background-color:white; padding: 20px; border-radius:150px 0px 150px 0px; border : 2px solid #b90112" >                   
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 offset-2" style="">
                            <center>
                                 <a href="ficheDC.php" target="_blank" title="Cliquer pour ajouter une Catégorie"><img src="../docs/emoticones/task5.jpg" width="40%" alt="Fiche Boisson" > </a>
                            </center>
                       ...
                       <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" style="">
                            <center>
                                 <a href="ficheDB.php" target="_blank"><img src="../docs/emoticones/task6.png" width="40%" alt="Ajout nourriture" > </a>
                            </center>
