...
<html>
    ...
    <body id="">
        ...
        <div id="sect1" class="row" style=" background-color:white; padding-top:20px;">
            ...
            <div class="col-lg-12"><h1 style="text-align:center" style="font-family: century gothic">Historique des achats</h1></div>
            ...
            <div class="col-lg-10" style="margin-top:30px; padding:20px; border: 2px solid #b90112; background-color:white; border-radius:150px 0px 150px 0px;">
                ...
                <div class="row" style=" padding: 20px;" > 
                    ...
                    <div class="col-lg-4" style="">
                        ...
                        <center title="">
                             <a href="histAchatNour.php" target="_blank" style="" >
                                <img src="../docs/emoticones/new/cuis1.png" width="40%" alt="Réquisition" > </a>
                        </center>
                        <legend style="color:black; text-align:center; border-bottom: 1px solid #b90112">Nourriture </legend>
                    </div>                    
                    
                    <div class="col-lg-4" style="">
                        
                         <center >
                             <a href="histAchatBoiss.php" target="_blank" >
                    ...
                    <div class="col-lg-4" style=" ">
                        ...
                        <center title="">
                             <a href="histAchatDiv.php" target="_blank" style="">
