<?php
    ...
    $req=$bd->query("SELECT * FROM etatbesoin WHERE etat='encours'");
 ?>
<!DOCTYPE html>
<html>
    <head>
                        ...
                        <div class="row">
                                <div class="col-lg-6 printR">
                                    <form action="" method="POST">
                                        <button type="submit" name="send" class="btn btn-danger pull-right"><span class="fa fa-send"></span> Valider</button>
                                    </form>
                                ...
                                <?php if (isset($_POST['send'])): 
                                    ?>
                                <?php
                                    $req=$bd->query("UPDATE etatbesoin SET etat='validé' WHERE etat='encours'"); 
                                    header('location:pages/comListReq.php');
                            endif ?>
                                <div class="col-lg-6">
