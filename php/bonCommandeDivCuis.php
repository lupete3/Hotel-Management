<?php
    ...
    require_once('bd_cnx.php');
        ...
        $req=$bd->query("SELECT A.idComCuis,A.qteComDiv,date_format(A.dateComDiv,'%e-%m-%Y à %T') as dateComDiv,B.designDivCuis,B.prixDivCuis FROM comcuisine as A,diverscuisine as B WHERE B.idDivCuis=A.idDivCuis AND A.statutComDiv = 'commande'");
        $req1=$bd->query("SELECT SUM(qteComDiv*prixDivCuis) as total FROM comcuisine as A,diverscuisine as B WHERE B.idDivCuis=A.idDivCuis AND A.statutComDiv = 'commande'");
            ...
            <div class="row" style="margin-bottom:10px;  " >
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                    ...
                    <p style="font-family:Century Gothic; font-size:1.5em; text-align:center; font-weight:bold;">
                        Bon de commande cuisine divers
                    </p>
                                        ...
                                        <?php 
                                            ...
                                            while ($don=$req->fetch(PDO::FETCH_ASSOC)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right"><?php echo $don['qteComDiv']*$don['prixDivCuis'] ?></td>
                                                </tr>
                                                <?php
                                                $num++;
                                            }
                    ...
                    <div class="container">
                        <div class="row">
                                ...
                                <?php if (isset($_POST['send'])): 
                                    ?>
                                <?php
                                    $req=$bd->query("UPDATE comcuisine SET statutComDiv='Encours' WHERE statutComDiv='commande'"); 
                                    header('location:pages/comDivCuis.php');
                            endif ?>
                                <div class="col-lg-6">
