...
<?php
    ...
    $dateJ=date('Y-m-d'); 
    $poste='econome';
    $req = $bd->prepare("SELECT A.idBoissAv,A.qteBoissAv,A.motif,date_format(A.dateBoissAv,'%e-%m-%Y à %T') as dateAv,A.postePvBoiss, B.designBoiss,B.puBoiss, B.idBoiss FROM prodboiss as B,avarieboiss as A WHERE A.idBoiss=B.idBoiss AND  A.dateBoissAv LIKE '%$dateJ%' AND postePvBoiss LIKE '%$poste%'");
        $req->execute();
        $req1 = $bd->prepare("SELECT SUM(qteBoissAv*puBoiss) AS total FROM avarieboiss as A, prodboiss as B WHERE A.idBoiss = B.idBoiss AND  dateBoissAv LIKE '%$dateJ%' AND postePvBoiss LIKE '%$poste%'");
        $req1->execute();
            ...
            <div class="row" style="border-bottom:1px solid black;margin-bottom:2px">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8" >
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top:70px;">
                        <h1 class="text-center text-uppercase" style="text-align:center; border: 1px solid black">Fiche Avarie Boisson
                        </h1>
                    ...
                    <table class="table table-bordered table-striped spacer">
                        ...
                        <tbody>
                                ...
                                <tr>
                                       ...
                                       <td class="text-right"><?php echo $don['qteBoissAv'] ?></td>
                                       <td class="text-right"><?php echo $don['puBoiss'] ?></td>
                                        <td class="text-right"><?php echo $don['motif'] ?></td>
                                        <td class="text-right"><?php echo $don['dateAv'] ?></td>
                                 

                                       
                                       <td class="text-right"><?php echo ($don['qteBoissAv']*$don['puBoiss']) ?></td>
                                        <td></td>
