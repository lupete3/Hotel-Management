<?php
    ...
    $dateJ=date('Y-m-d');
    $req = $bd->prepare("SELECT date_format(A.dateApprov,'%d-%m-%Y') as dateApprov,A.qteSortie,B.prixDivCuis,B.designDivCuis FROM sortiecuisine as A,diverscuisine as B WHERE B.idDivCuis=A.idDivCuis AND  A.dateApprov LIKE '%$dateJ%'");
        $req->execute();
        $req1 = $bd->prepare("SELECT SUM(qteSortie*prixDivCuis) AS total FROM sortiecuisine as A,diverscuisine as B WHERE B.idDivCuis=A.idDivCuis AND dateApprov LIKE '%$dateJ%'");
        $req1->execute();
    ...
    if (isset($_GET['save'])) {
        ...
        $req = $bd->prepare("SELECT date_format(A.dateApprov,'%d-%m-%Y') as dateApprov,A.qteSortie,B.prixDivCuis,B.designDivCuis FROM sortiecuisine as A,diverscuisine as B WHERE B.idDivCuis=A.idDivCuis AND  A.dateApprov BETWEEN ? AND ?");
        $req->execute(array($in,$out));
        $req1 = $bd->prepare("SELECT SUM(qteSortie*prixDivCuis) AS total FROM sortiecuisine as A,diverscuisine as B WHERE B.idDivCuis=A.idDivCuis AND dateApprov BETWEEN ? AND ?");
            ...
            <div class="row" style="border-bottom:1px solid black;margin-bottom:2px">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8" >
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top:70px;">
                        <h3 class="text-center text-uppercase" style="text-align:center; border: 1px solid black">Fiche sortie produits connexe cuisine
                    ...
                    <table class="table table-bordered table-striped spacer">
                        ...
                        <tbody>
                                ...
                                <tr>
                                       ...
                                       <td class="text-right"><?php echo $don['qteSortie'] ?></td>
                                       <td class="text-right"><?php echo $don['dateApprov'] ?></td>
