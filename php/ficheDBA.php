<?php
    ...
    $req = $bd->prepare("SELECT  montantEntreeBanque,date_format(dateEntreeBanque,'%d-%m-%Y') as dateEntreeBanque,motifEntreeBanque FROM entreeBanque WHERE  dateEntreeBanque LIKE '%$dateJ%' ");
        $req->execute();
        $req1 = $bd->prepare("SELECT SUM(montantEntreeBanque) AS total FROM entreeBanque WHERE dateEntreeBanque LIKE '%$dateJ%'");
        $req1->execute();
    ...
    if (isset($_GET['save'])) {
        ...
        $req = $bd->prepare("SELECT  montantEntreeBanque,date_format(dateEntreeBanque,'%d-%m-%Y') as dateEntreeBanque,motifEntreeBanque FROM entreeBanque WHERE  dateEntreeBanque BETWEEN ? AND ? ");
        $req->execute(array($in,$out));
        $req1 = $bd->prepare("SELECT SUM(montantEntreeBanque) AS total FROM entreeBanque WHERE dateEntreeBanque BETWEEN ? AND ? ");
            ...
            <div class="row" style="border-bottom:1px solid black;margin-bottom:2px">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8" >
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top:70px;">
                        <h1 class="text-center text-uppercase" style="text-align:center; border: 1px solid black">Fiche d'entrée Banque
                    ...
                    <table class="table table-bordered table-striped spacer">
                        ...
                        <tbody>
                                ...
                                <tr>
                                        ...
                                        <td><?php echo $don['dateEntreeBanque'] ?></td>
                                        <td class="text-right"><?php echo $don['montantEntreeBanque'] ?></td>
                                        <td></td>
