    ...
    <body id="">
        <header id="head" style="background-color: #b90112;"> 
            <div class="row"> 
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-7" id="div_lgos" style="padding-top: 30px;">
            ...
            <div class="col-lg-10" style="padding:1%;">
                <div class="row" style="text-align:center;">
                    <div class="col-md-12 text-center text-uppercase">
                        <h1 style="color:black; font-family: century gothic;" class="text-center">Check In / Check Out</h1>
                    </div>
                </div>
                 
                <div class="container" style="background-color:white; padding: 20px; border-radius:200px 0px 200px 0px; border : 2px solid #b90112" >                   

                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">


                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 offset-2" style="">
                            <center>
                                 <a href="pages/checkin.php" title="Cliquer pour ajouter une Catégorie">
                                     <img src="../docs/MAJ/checkin2.png" width="40%" alt="Fiche Boisson" > </a>
                            </center>
                            <legend style="color:black; font-family: century gothic; text-align:center;">Check In</legend>
                        </div> 

                       <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" style="">
                            <center>
                                 <a href="pages/listReservCh.php" >
                                     <img src="../docs/MAJ/checkOut.png" width="40%" alt="Ajout nourriture" > </a>
                            </center>
                            <legend style="color:black; font-family: century gothic; text-align:center;">Check Out</legend>
                        </div>   
