...
<html>
    ...
    <body id="">
        ...
        <div id="sect1" class="row" style=" background-color:white; padding-top:20px;">
            ...
            <div class="col-lg-12"><h1 style="text-align:center">Etat de besoins</h1></div>
            ...
            <div class="col-lg-10" style="margin-top:30px; padding:10px; border: 2px solid #b90112; background-color:white; border-radius:50px;">
                ...
                <div class="row" style=" padding: 20px;" > 
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6" style="">
                        ...
                        <center title="">
                             <a href="pages/etatBesoin.php" style="" >
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6" style=" ">
                        ...
                        <center title="">
                             <a href="pages/etatBesoinEncours.php" style="">
                                <img src="../docs/emoticones/cleaning.png" width="40%" alt="Sauna-Gym-Piscine" > </a>
                        </center>
                        <legend style="color:grey; text-align:center; border-bottom: 1px solid #b90112">Commande en cours</legend>
                    </div> 
            ...
            <div style="text-align:center; color:grey;">
                    Copyright &copy;<script>document.write(new Date().getFullYear());</script> Tous droits réservés | Ce modèle est fait par <a style="color:gray" href="https://softech-rdc.com" target="_blank">Soft Tech Corporation</a>
                </div>
