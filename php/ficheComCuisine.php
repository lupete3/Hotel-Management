                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                                <?php
                                $dateJ=date('Y-m-d');
                                $req = $bd->query("SELECT * FROM commandenour AS A ,catnour AS B , prodnour AS C WHERE A.idNour=C.idNour AND C.idCatNour=B.idCatNour AND dateComNour LIKE '%$dateJ%' AND statutComNour='Validé'");
                            ...
                            $num++;
                             ...
                             <tr>
                                <td colspan="5"><strong>Total</strong></td>
                                 <td ><strong>
                                     <?php 
                                        $req1=$bd->query("SELECT SUM(qteComNour*puNour) as total FROM commandenour AS A ,catnour AS B , prodnour AS C WHERE A.idNour=C.idNour AND C.idCatNour=B.idCatNour AND dateComNour LIKE '%$dateJ%' AND statutComNour='Validé'");
