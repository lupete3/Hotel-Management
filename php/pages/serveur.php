						...
						<div class="input-group mb-4">	           			
		           		...
		           		<div class="input-group mb-4">	           			
							<div class="input-group-append">
			           		...
			           		<select name="sexe" class="form-control btn-lg" id='pu'>
		           		...
		           		<div class="input-group mb-4">	           			
							<div class="input-group-append">
		           			...
		           			<input type="text" name="contact" class="form-control btn-lg" id="pu1" required="" autocomplete="off"><br>
		           		</div>		           		
					</div>
	...
	<div class="container spacer">
		<div class="row">
			...
			<div class="col-md-4">
				...
				<?php
		          		if (isset($_POST['save'])) {
							  ...
							  $l=$_FILES['photo']['name'];
							  $l_tmp=$_FILES['photo']['tmp_name'];
        					  move_uploaded_file($l_tmp,"fichiers/photos/$l");

        					
							  $req=$bd->prepare('SELECT * FROM serveur WHERE nom_serveur=? AND sexe_serveur = ? AND etatCivil = ? ');
							  ...
							  if ($don=$req->fetch(PDO::FETCH_ASSOC)) {
								...
								<?php
							  	...
							  	$req = $bd->prepare('INSERT INTO serveur(nom_serveur, sexe_serveur, etatCivil,pays, adresse, piece, numPiece, lieuDel, dateDel, telServeur, email,photo) 
                            VALUES 
                                (?,?,?,?,?,?,?,?,?,?,?,?)') ;
			...
			<div class="col-md-3 offset-5">
				<a href="listServeur.php"><button class="btn btn-danger btn-lg pull-right" type="button"><span class="fa fa-list"></span> Liste Serveur</button></a>
			</div>
		</div><br>
			...
			<div class="row">
				<div class="col-md-4">
						...
						<select name="sexe" class="form-control btn-lg" required="">
		           		...
		           		<input type="email" name="email" class="form-control btn-lg" placeholder="example@gmail.com" required="" autocomplete="off"><br>
				...
				<div class="col-md-4">
					...
					<div class="input-group mb-4">
						<select name="piece" class="form-control btn-lg" required="">
					...
					<div class="input-group mb-4">	           			
							<div class="input-group-append">
		           				<span class="input-group-text" id="basic-addon2">Photo Serveur</span>
		           			</div>
