						...
						<div class="input-group mb-4">	           			
		           		...
		           		<div class="input-group mb-4">	           			
							<div class="input-group-append">
		           			...
		           			</div><select name="sexe" class="form-control" id='pu'>
		           		...
		           		<div class="input-group mb-4">	           			
							<div class="input-group-append">
		           			...
		           			<input type="text" name="adresse" class="form-control" id="pu2" required="" autocomplete="off"><br>
		           		</div>
		           		<div class="input-group mb-4">	           			
							<div class="input-group-append">
		           				<span class="input-group-text" id="basic-addon2">Numero de telephone</span>
		           			</div>
		           			<input type="text" name="contact" class="form-control" id="pu1" required="" autocomplete="off">
		           		</div>		           		
					</div>
	      ...
	      <div class="col-md-12">
	      	<div class="row">
	      		<div class="col-md-4">
			          ...
			          <?php 
		                    $count = $bd->query('SELECT  COUNT(*) AS nbre FROM client');
	      		...
	      		<div class="offset-4 col-md-4">
	      			<a href="client.php"><button class="btn btn-danger btn-lg pull-right" type="button"><span class="fa fa-plus"></span> Ajouter client</button></a>
	      		</div>
	      	</div>
	 				...
	 				<table id="tab" class="display table table-bordered table-striped table">
		          	...
		          	<tbody>
		          		<?php
							...
							$req = $bd->query("SELECT * FROM client as A INNER JOIN organisation AS B ON B.idOrg=A.idOrg ORDER BY id_client DESC LIMIT $start,$limit");
							...
							if ($page==$nbrePage) {
		          			...
		          			while($don=$req->fetch()):
		          				?>
		          		<tr>
                                <td><?php echo $don['id_client'] ?></td>
                                <td><?php echo $don['nom_client'] ?></td>
                                <td><?php echo $don['sexe_client'] ?></td>
                                <td><?php echo $don['pays'] ?></td>
                                <td><?php echo $don['nomOrg'] ?></td>
                                <td><?php echo $don['telClient'] ?></td>
                                <td><?php echo $don['piece'] ?></td>
                                <td><?php echo $don['numPiece'] ?></td>
								<td>
	          ...
	          <div class="row">
	          	 <div class="col-3 offset-9">
	          	 	<nav aria-label="Page navigation example">
			    		...
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Previous" href="listClient.php?page=<?php echo $prec;?>">
			    		...
			    		?> 
			    		<li class="page-item <?php echo(($page==$i)?'active':'')?>"><a  class="page-link" href="listClient.php?page=<?php echo $i;?>"><?php echo $i;?></a></li>
			    		<?php
			    		}?>
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Next" href="listClient.php?page=<?php echo $suiv;?>">
