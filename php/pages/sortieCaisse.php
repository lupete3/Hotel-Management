		          ...
		          <?php
		          		if (isset($_POST['save'])){
					        ...
					        if ($a <= $limit ) {
						        ...
						        $req = $bd->prepare('INSERT INTO sortiecaisse (montantSortie,motifSortie,agent) VALUES (?,?,?)');
		           ...
		           <form action="" method="POST" class="spacer was-validated">
		           		...
		           		<div class="input-group mb-4">	           			
		           			<input type="text" name="motifSortieCaisse" class="form-control btn-lg" placeholder="Motif " required="" autocomplete="off">
		           		</div>
	      ...
	      <div class="col-md-9">
	          <div class="row">
				...
				<div class="col-md-5 col-sm-5 col-lg-5 col-xl-5 offset-2" >
					<h3 class="title">DISPONIBLE EN CAISSE : <?php echo number_format($don['montantCaisse'],2); ?> $ </h3>
				</div>
	          </div>
	 				...
	 				<table id="tab" class="display table table-bordered table-striped table">
		          	...
		          	<tbody>
		          		<?php
							...
							$req = $bd->query("SELECT * FROM sortiecaisse ORDER BY idSortieCaiss DESC LIMIT $start,$limit");
