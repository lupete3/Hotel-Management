	...
	<div class="modal fade" id="editBtn" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form action="upComListDiv.php" method="POST" class="was-validated">
	...
	<div class="container-fluid spacer">
		<div class="row">   
	      <div class="col-md-8 offset-2">
	          <h3 class="title">LISTE DE COMMANDES EN COURS DE DIVERS</span></h3>
	          <?php 
	 				...
	 				<table id="tab" class="display table table-bordered table-striped table">
		          	...
		          	<tbody>
		          		<?php
							...
							$req = $bd->query("SELECT A.poste, A.idComDiv,A.qteComDiv,date_format(A.dateComDiv,'%e-%m-%Y à %T') as dateComDiv,B.designation  FROM comDivers as A,stockdivers as B WHERE B.idDiv=A.idDiv AND A.statutComDiv = 'Encours' LIMIT $start,$limit");
							
							$res = $bd->query("SELECT count(*) as total FROM comDivers as A,stockdivers as B WHERE B.idDiv=A.idDiv AND A.statutComDiv = 'Encours'");
	          ...
	          <div class="row">
	          	 <div class="col-3 offset-9">
	          	 	<nav aria-label="Page navigation example">
			    		...
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Previous" href="comListDivA.php?page=<?php echo $prec;?>">
			    		...
			    		?> 
			    		<li class="page-item <?php echo(($page==$i)?'active':'')?>"><a  class="page-link" href="comListDivA.php?page=<?php echo $i;?>"><?php echo $i;?></a></li>
			    		<?php
			    		}?>
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Next" href="comListDivA.php?page=<?php echo $suiv;?>">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form action="upMixComDivA.php" method="POST">
					<div class="modal-body">
	...
	<div class="modal fade" id="delBtn" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form action="delMixComDivA.php" method="POST">
					<div class="modal-body">
						<input type="hidden" name="idSup" id="idDel" required="" autocomplete="off"><br>
		           		<div class="input-group mb-4">	 
		           			<h4 class="text-center">Voulez-vous supprimer cette commande ?</h4>
