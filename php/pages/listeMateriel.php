	...
	<div class="container-fluid spacer">
		<div class="row">
	      <div class="col-md-12">
	      	<div class="row">
	      		<div class="col-md-4">
	      			<h3>LISTE DES MATERIELS
			          <?php 
		                    $count = $bd->query('SELECT  COUNT(*) AS nbre FROM materiel');
	 				...
	 				<table id="tab" class="display table table-bordered table-striped table">
		          	...
		          	<tbody>
		          		<?php
							...
							$req = $bd->query("SELECT idMat,A.idCatEq,designation,designMat,marque, quantite, prixAchat, date_format(dateAcqui,'%d-%m-%Y')AS dateAcqui FROM materiel AS A INNER JOIN categorieequip AS B ON B.idCatEq=A.idCatEq ");
			          			while($don=$req->fetch()):
		          				?>
		          		<tr>
