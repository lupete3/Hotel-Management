			...
			<div class="modal-content">
				...
				<form action="upApprov.php" method="POST" class="was-validated">
					<div class="modal-body">
					    ...
					    <div class="input-group mb-4">	           			
								<input type="text" name="accompte" class="form-control" id="acc" required="" autocomplete="off" placeholder="Accompte">
							<div class="input-group-append">
		           				<span class="input-group-text fa fa-usd" id="basic-addon2"></span>
		           			</div>
					    </div>
			...
			<div class="col-md-3">
		          ...
		          <?php
		          		if (isset($_POST['save'])) {
							  ...
							  $req=$bd->prepare('INSERT INTO approvBoiss(idBoiss,idFour,qnteApprov,puApprov,ptApprov,modeAchat,accompte,reste) VALUES(?,?,?,?,?,?,?,?)');
							  
							if ($req->execute(array($a,$b,$c,$d,$e,$modeP,$accompte,$reste)))
							     {
							...
							$detteFour->execute(array($design,$c,$d,$e,$modeP,$id,$diff,$accompte,$reste,$b));
		           ...
		           <form action="" method="POST" class="spacer was-validated">
                        ...
                        <select id="select" class="form-control" name="idFour" required="">
		           		...
		           		<div class="input-group mb-4">	           			
							<input type="text" name="accompte" class="form-control" id="accompte" required="" autocomplete="off" placeholder="Accompte"><br>
					    </div>	
	 				...
	 				<table id="tab" class="display table table-bordered table-striped table">
		          	...
		          	<tbody>
		          		<?php
							...
							$req = $bd->query("SELECT * FROM approvboiss as A,four as B,prodboiss as C WHERE C.idBoiss=A.idBoiss AND B.idFour=A.idFour ORDER BY idApprovBoiss DESC LIMIT  $start,$limit");
							
							$res = $bd->query('SELECT COUNT(*) as total FROM approvboiss as A,four as B,prodboiss as C WHERE C.idBoiss=A.idBoiss AND B.idFour=A.idFour');
