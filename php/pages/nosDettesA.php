	...
	<div class="container-fluid spacer">
		<div class="row">
	      <div class="col-md-12">
	      	<div class="row">
	      		<div class="col-md-6">
	      			<h3>LISTES DES DETTES FOURNISSEURS</h3>
	      		</div>
	      		<div class="col-md-6 pull-right">
	      			<h3 class="">
	      				Total des dettes: <strong><span class="badge badge-danger btn-lg">
	      					<?php 
	      					$req = $bd->query("SELECT SUM(reste) as total FROM dettefour AS A INNER JOIN four AS B ON B.idFour=A.idFour WHERE modePaieDette='Crédit'");
	 				...
	 				<table id="tab" class="display table table-bordered table-striped table">
		          	...
		          	<tbody>
		          		<?php 
		                    ...
		                    $req = $bd->query("SELECT * FROM dettefour AS A INNER JOIN four AS B ON B.idFour=A.idFour WHERE modePaieDette='Crédit' GROUP BY B.idFour");
		                
		          			while ($don=$req->fetch(PDO::FETCH_ASSOC)) {
		          				?>
								<tr>
	                               <td><?php echo $don['idDetteF']; ?></td>
	                               <td><?php echo $don['nomFour'] ;?></td>
	                               <td><?php echo $don['telFour']; ?></td>
	                               <td><?php echo $don['designProd']; ?></td>
	                               <td><?php echo $don['dateDette']; ?></td>
	                               <td>
										<a href="../paiementFourA.php?id=<?php echo $don['idFour'];?>&idDette=<?php echo $don['idDetteF'];?>" target="_blank" data-toggle="tooltip" title="Cliquer pour modifier la commande">
