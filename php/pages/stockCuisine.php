...
<body>
	...
	<div class="modal fade" id="delBtn" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form action="delProdNourCuis.php" method="POST">
	...
	<div class="container-fluid spacer">
		<div class="row">
			<div class="col-md-3">
		          <h3 class="title">AJOUTER NOURRITURE</span></h3>
		          <?php
		          		if (isset($_POST['save'])) {
		          			...
		          			if (!empty($idNour) ) {
    							...
    							if ($don>0) { ?>
    								<div class="alert alert-danger alert-dismissible" id="msg" role="alert">
										...
										<h6>Nourriture  déjà disponible en stock</h6>
									</div>
					            ...
					            $req = $bd->prepare('INSERT INTO stockcuisine(idNour) VALUES (?)');
					            $req->execute(array($idNour));
					            if ($req) { ?>
		           ...
		           <form action="" method="POST" class="spacer was-validated">
		           		...
		           		<select name="idNour" id="list_nour" class="form-control">
	      ...
	      <div class="col-md-9">
	          <h3 class="title">LISTE DE NOURRITURES DISPONIBLES</span></h3>
	 				...
	 				<table id="tab" class="display table table-bordered table-striped table-SM">
		          	...
		          	<tbody>
		          		<?php
							...
							$req = $bd->prepare('SELECT * FROM stockcuisine,prodNour WHERE stockcuisine.idNour=prodNour.idNour');
							$req->execute(array());


							$res = $bd->query("SELECT count(*) as total FROM stockcuisine,prodNour WHERE stockcuisine.idNour=prodNour.idNour LIMIT $start,$limit");
							...
							if ($page==$nbrePage) {
		          			...
		          			while($don=$req->fetch()):
		          				...
		          				?>
		          		<tr>
                                <td><?php echo $don['idStockCuis'] ?></td>
                                <td><?php echo $don['designNour'] ?></td>
                                <td><?php echo $don['qtStockCuis'] ?></td>
                                <!--<td>
	          ...
	          <div class="row">
	          	 <div class="col-6 offset-6">
	          	 	<nav aria-label="Page navigation example">
			    		...
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Previous" href="stockCuisine.php?page=<?php echo $prec;?>">
			    		...
			    		?> 
			    		<li class="page-item <?php echo(($page==$i)?'active':'')?>"><a  class="page-link" href="stockCuisine.php?page=<?php echo $i;?>"><?php echo $i;?></a></li>
			    		<?php
			    		}?>
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Next" href="stockCuisine.php?page=<?php echo $suiv;?>">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header bg-danger">
					<h4 class="modal-title" id="exampleModalLabel">MODIFICATION PRODUIT</h4>
					<button type="button" class="close" data-dismiss="modal" aria-label="close">
						<span aria-hidden="true">&times;</span>
					</button>
						
				</div>
				<form action="upNourCuis.php" method="POST" class="was-validated">
					<div class="modal-body">
						<input type="hidden" name="id" id="id" required="" autocomplete="off"><br>
		           		<input type="text" name="qnte" id="qte" class="form-control" placeholder="Quantité " required="" autocomplete="off">
					</div>
					<div class="modal-footer">
						<button type="button" class="btn btn-outline-secondary btn-block" data-dismiss="modal">Annuler</button>
