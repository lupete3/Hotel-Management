	...
	<div class="modal fade" id="editBtn" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form action="upComReq.php" method="POST" class="was-validated">
					<div class="modal-body">
						<input type="hidden" name="id" id="id" required="" autocomplete="off">
		           		<div class="input-group mb-4">	 
		           			...
		           			<input id="pu" type="text" name="pu" class="form-control" placeholder="Quantite Demandée" required="" autocomplete="off">
	...
	<div class="container-fluid spacer">
		<div class="row">   
	      <div class="col-md-8 offset-2">
	          <h3 class="title">LISTE DE COMMANDES EN COURS
	          	<a href="../ficheComEcoA.php"><button class="btn btn-danger btn-lg pull-right" type="button"><span class="fa fa-print"></span> Imprimer</button></a>
	          	<span class="badge badge-danger">
	          		<strong>
                       <?php
                            $req=$bd->query("SELECT SUM(pt) as total FROM etatbesoin WHERE etat='encours'");
	 				...
	 				<table id="tab" class="display table table-bordered table-striped table-sm">
		          	...
		          	<tbody>
		          		<?php
							...
							$req = $bd->query("SELECT * FROM etatbesoin WHERE etat='encours' LIMIT $start,$limit");
	          ...
	          <div class="row">
	          	 <div class="col-3 offset-9">
	          	 	<nav aria-label="Page navigation example">
			    		...
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Previous" href="comListReq.php?page=<?php echo $prec;?>">
			    		...
			    		?> 
			    		<li class="page-item <?php echo(($page==$i)?'active':'')?>"><a  class="page-link" href="comListReq.php?page=<?php echo $i;?>"><?php echo $i;?></a></li>
			    		<?php
			    		}?>
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Next" href="comListReq.php?page=<?php echo $suiv;?>">
	...
	<div class="modal fade" id="supBtn" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form action="confReq.php" method="POST">
					<div class="modal-body">
	...
	<div class="modal fade" id="cancelBtn" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form action="supReq.php" method="POST">
					<div class="modal-body">
