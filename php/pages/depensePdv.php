<?php 
	...
	$agent=isset($_SESSION['profil']['agent2'])?$_SESSION['profil']['agent2']['user_name']:'';
	...
	<div class="modal fade" id="editBtn" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form action="upDepR.php" method="POST" class="was-validated">
		...
		<div class="row">
	      ...
	      <div class="col-md-9">
	          <div class="row">
				...
				<?php 
				$in=date('Y-m-d');
				$req = $bd->query("SELECT SUM(montantDp) as total FROM depensePdv WHERE agentDp='$agent' AND dateDp LIKE '%$in%'");
	          ...
	          <div class="row">
	          	 <div class="col-3 offset-9">
	          	 	<nav aria-label="Page navigation example">
			    		...
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Previous" href="depensePdv.php?page=<?php echo $prec;?>">
			    		...
			    		?> 
			    		<li class="page-item <?php echo(($page==$i)?'active':'')?>"><a  class="page-link" href="depensePdv.php?page=<?php echo $i;?>"><?php echo $i;?></a></li>
			    		<?php
			    		}?>
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Next" href="depensePdv.php?page=<?php echo $suiv;?>">
