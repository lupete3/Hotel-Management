		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<ul class="navbar-nav ml-auto">
				<li class="nav-item active">
					<a class="nav-link" href="../rapportComptable.php"><button type="button" class="btn btn-outline-light connexion"><h3>Retour</h3></button><span class="sr-only">(current)</span></a>
				</li>
			</ul>
	...
	<div class="container-fluid spacer">
		...
		<div class="row">
			<div class="col-md-4 offset-8 pull-right">
				<h5>
					Comptable <?php echo(isset($_SESSION['profil']['agent4'])?$_SESSION['profil']['agent4']['user_name']:''); ?>
				</h5>
			</div>
		</div>
	</div>
