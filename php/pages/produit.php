				...
				<form action="upProd.php" method="POST" class="was-validated">
					<div class="modal-body">
						...
						<select id="select" class="form-control" name="idCatBoiss" required="">
		           		...
		           		<input type="text" name="designBoiss" class="form-control" placeholder="Désignation boisson" required="" autocomplete="off" id="des"><br>
		           		<div class="input-group mb-4">	           			
		           			<input type="text" name="qnteBoiss" id="qte" class="form-control" placeholder="Stock initial" required="" autocomplete="off">
		           			<div class="input-group-append">
		           				<span class="input-group-text fa fa-gift" id="basic-addon2"></span>
		           			</div>
		           		</div>	
		           		<input type="text" name="nbUniteBoiss" id="nbre" class="form-control" placeholder="Nombre de pièce" required="" autocomplete="off"><br>
		           		<div class="input-group mb-4">	           			
		           			<input type="text" name="puBoiss" id="pu" class="form-control" placeholder="Prix unitaire" required="" autocomplete="off">
		           			<div class="input-group-append">
			...
			<div class="col-md-3">
		          ...
		          <?php
		          		if (isset($_POST['save'])) {
							  ...
							  if ($don=$req->fetch(PDO::FETCH_ASSOC)) {
								...
								<?php
							      ...
							      $req=$bd->prepare('INSERT INTO prodboiss(idCatBoiss,designBoiss,qnteBoiss,nbUniteBoiss,puBoiss,valUnitBoiss) VALUES(?,?,?,?,?,?)');
		           ...
		           <form action="" method="POST" class="spacer was-validated">
		           		...
		           		<input type="text" name="designBoiss" class="form-control" placeholder="Désignation boisson" required="" autocomplete="off"><br>
		           		<div class="input-group mb-4">	           			
		           			<input type="text" name="qnteBoiss" class="form-control" placeholder="Stock initial" required="" autocomplete="off">
		           			<div class="input-group-append">
		           				<span class="input-group-text fa fa-gift" id="basic-addon2"></span>
		           			</div>
		           		</div>	
		           		...
		           		<div class="input-group mb-4">	           			
		           			<input type="text" name="puBoiss" class="form-control" placeholder="Prix unitaire de vente" required="" autocomplete="off">
		           			<div class="input-group-append">
		           				<span class="input-group-text fa fa-usd" id="basic-addon2"></span>
		           			</div>
		           		</div>
	 				...
	 				<table id="tab" class="display table table-bordered table-striped table-sm">
		          	...
		          	<tbody>
		          		<?php
							...
							$req = $bd->query("SELECT * FROM prodboiss AS A INNER JOIN catboiss AS B ON B.idCatBoiss=A.idCatBoiss LIMIT $start,$limit");
