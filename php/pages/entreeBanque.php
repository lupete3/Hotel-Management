			...
			<div class="modal-content">
				...
				<form action="upSortieBanque.php" method="POST" class="was-validated">
					<div class="modal-body">
						...
						<input type="hidden" name="mtS" id="mtB" required="" autocomplete="off">
						
		           		<div class="input-group mb-4">	
		           		<input type="text" name="mtSortieBanque" id="mt"class="form-control btn-lg" placeholder="Montant " required="" autocomplete="off">	
		           		</div>
		           		<div class="input-group mb-4">	           			
			...
			<div class="col-md-3">
		          ...
		          <?php
		          		if (isset($_POST['save'])){
		          			...
		          			$a=$_POST['mEntreBanque'];
							$b=$_POST['motifEntreBanque'];

							$c=$_FILES['bord']['name'];
							$c_tmp=$_FILES['bord']['tmp_name'];
        					move_uploaded_file($c_tmp,'fichiers/bordereaux/'.basename($_FILES['bord']['name']));
    
					        $req = $bd->prepare('INSERT INTO entreebanque (montantEntreeBanque,motifEntreeBanque,doc) VALUES (?,?,?)');
		           ...
		           <form action="" method="POST" class="spacer was-validated" enctype="multipart/form-data">
						...
						<div class="input-group mb-4">
		           			<input type="number" name="mEntreBanque" class="form-control btn-lg" placeholder="Montant " required="" autocomplete="off">	
		           			<div class="input-group-prepend">
		           				<span class="input-group-text fa fa-usd"></span>
		           			</div>	
		           		</div>
		           		<div class="input-group mb-4">	           			
		           			<input type="text" name="motifEntreBanque" class="form-control btn-lg" placeholder="Motif " required="" autocomplete="off">
		           		</div>
		           		<div class="input-group mb-4">
		           			<div class="input-group-prepend">
	      	...
	      	<div class="row">
				<div class="col-md-5 col-sm-5 col-lg-5 col-xl-5">
					...
					<div class="col-md-5 col-sm-5 col-lg-5 col-xl-5 offset-2" >
						<h4 class="title">Disponible en banque : <?php echo number_format($don['montantBanque'],2); ?> $ </h4>
					</div>
	        	</div>
	 				...
	 				<table id="tab" class="display table table-bordered table-striped table">
		          	...
		          	<tbody>
		          		<?php
							...
							$req = $bd->query("SELECT * FROM entreebanque ORDER BY idEntreeBanque LIMIT $start,$limit");
							
							$res = $bd->query("SELECT COUNT(*) as total FROM entreebanque");
							...
							if ($page==$nbrePage) {
		          			...
		          			while($don=$req->fetch()):
		          				?>
		          		<tr>
                                <td><?php echo $don['idEntreeBanque'] ?></td>
                                <td><?php echo $don['montantEntreeBanque'] ?></td>
                                <td><?php echo $don['motifEntreeBanque'] ?></td>
                                <td>
	          ...
	          <div class="row">
	          	 <div class="col-3 offset-9">
	          	 	<nav aria-label="Page navigation example">
			    		...
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Previous" href="entreeBanque.php?page=<?php echo $prec;?>">
			    		...
			    		?> 
			    		<li class="page-item <?php echo(($page==$i)?'active':'')?>"><a  class="page-link" href="entreeBanque.php?page=<?php echo $i;?>"><?php echo $i;?></a></li>
			    		<?php
			    		}?>
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Next" href="entreeBanque.php?page=<?php echo $suiv;?>">
