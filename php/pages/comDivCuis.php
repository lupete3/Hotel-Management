	...
	<div class="modal fade" id="supBtn" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<form action="deleteComDivCuis.php" method="POST">
		...
		<div class="row">
		          		...
		          		if (isset($_POST['save'])) {
							...
							$d=$_POST['idDiv'];
		          			...
		          			if (!empty($a) AND !empty($d) ) {
					            $req = $bd->prepare('INSERT INTO comcuisine (qteComDiv,statutComDiv,idDivCuis) VALUES (?,?,?)');
					            $req->execute(array($a,$b,$d));
					            if ($req) { ?>
	      ...
	      <div class="col-md-9">
	      	<div class="row">
				...
				<a href="../bonCommandeDivCuis.php"><button class="btn btn-danger btn-lg pull-right" type="button"><span class="fa fa-print"></span> Bon de commande</button></a>
			</div>
	 				...
	 				<table id="tab" class="display table table-bordered table-striped table">
		          	...
		          	<tbody>
		          		<?php
							...
							$req = $bd->query("SELECT A.idComCuis,A.qteComDiv,date_format(A.dateComDiv,'%e-%m-%Y à %T') as dateComDiv,B.designDivCuis FROM comcuisine as A,diverscuisine as B WHERE B.idDivCuis=A.idDivCuis AND A.statutComDiv = 'commande' ORDER BY idComCuis LIMIT $start,$limit");
							
							$res = $bd->query("SELECT count(*) as total FROM comcuisine as A,diverscuisine as B WHERE B.idDivCuis=A.idDivCuis AND A.statutComDiv = 'commande' ORDER BY idComCuis");
	          ...
	          <div class="row">
	          	 <div class="col-3 offset-9">
	          	 	<nav aria-label="Page navigation example">
			    		...
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Previous" href="comDiv.php?page=<?php echo $prec;?>">
			    		...
			    		?> 
			    		<li class="page-item <?php echo(($page==$i)?'active':'')?>"><a  class="page-link" href="comDiv.php?page=<?php echo $i;?>"><?php echo $i;?></a></li>
			    		<?php
			    		}?>
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Next" href="comDiv.php?page=<?php echo $suiv;?>">
