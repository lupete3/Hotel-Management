	...
	<div class="container-fluid spacer">
		<div class="row">
			<div class="col-md-3">
		          ...
		          <?php
		          		if (isset($_POST['save'])) {
							  $a=$_POST['designCatNour'];

							  $req=$bd->prepare('SELECT * FROM catnour WHERE designCatNour=?');
							  $req->execute(array($a));
							  if ($don=$req->fetch(PDO::FETCH_ASSOC)) {
								...
								<?php
							  	...
							  	$req=$bd->prepare('INSERT INTO catnour(designCatnour) VALUES(?)');
		           ...
		           <form action="" method="POST" class="spacer was-validated">
		           		...
		           		<input type="text" name="designCatNour" class="form-control" placeholder="Désignation catégorie" required="" autocomplete="off"><br>
	 				...
	 				<table id="tab" class="display table table-bordered table-striped table">
		          	...
		          	<tbody>
		          		<?php
							...
							$req = $bd->query("SELECT * FROM catnour LIMIT $start,$limit");
							
							$res = $bd->query('SELECT COUNT(*) as total FROM catnour');
	          ...
	          <div class="row">
	          	 <div class="col-3 offset-9">
	          	 	<nav aria-label="Page navigation example">
			    		...
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Previous" href="categorieNour.php?page=<?php echo $prec;?>">
			    		...
			    		?> 
			    		<li class="page-item <?php echo(($page==$i)?'active':'')?>"><a  class="page-link" href="categorieNour.php?page=<?php echo $i;?>"><?php echo $i;?></a></li>
			    		<?php
			    		}?>
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Next" href="categorieNour.php?page=<?php echo $suiv;?>">
