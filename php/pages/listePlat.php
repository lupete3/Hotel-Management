	      ...
	      <div class="col-md-12">
	      	<div class="row">
	      		<div class="col-md-4">
	      			<h3>LISTE DES PLATS
			          <?php 
		                    $count = $bd->query('SELECT  COUNT(*) AS nbre FROM plat');
	 				...
	 				<table id="tab" class="display table table-bordered table-striped table">
		          	...
		          	<tbody>
		          		<?php
							...
							$req = $bd->query("SELECT * FROM plat as A INNER JOIN catplat AS B ON A.idCatPlat=B.idCatPlat ");
