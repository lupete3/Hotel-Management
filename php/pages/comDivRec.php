			...
			<div class="modal-content">
				...
				<form action="upComDivRec.php" method="POST" class="was-validated">
					<div class="modal-body">
						<input type="text" name="id" id="id" required="" autocomplete="off"><br>
                        ...
                        <div class="input-group mb-4">	           			
		           		...
		           		<div class="input-group mb-4">	 
		           			...
		           			<input id="qteComDiv" type="text" name="qteComDiv" class="form-control" placeholder="Quantite Demandée" required="" autocomplete="off">
		...
		<div class="row">
	      ...
	      <div class="col-md-9">
	      	<div class="row">
				...
				<a href="../bonCommandeRecDiv.php"><button class="btn btn-danger btn-lg pull-right" type="button"><span class="fa fa-print"></span> Bon de commande</button></a>
			</div>
	          ...
	          <div class="row">
	          	 <div class="col-3 offset-9">
	          	 	<nav aria-label="Page navigation example">
			    		...
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Previous" href="comDivRec.php?page=<?php echo $prec;?>">
			    		...
			    		?> 
			    		<li class="page-item <?php echo(($page==$i)?'active':'')?>"><a  class="page-link" href="comDivRec.php?page=<?php echo $i;?>"><?php echo $i;?></a></li>
			    		<?php
			    		}?>
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Next" href="comDivRec.php?page=<?php echo $suiv;?>">
	...
	<div class="modal fade" id="supBtn" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<form action="deleteComDivRec.php" method="POST">
						<div class="modal-body">
