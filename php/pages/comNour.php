	...
	<div class="modal fade" id="editBtn" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form action="upComNour.php" method="POST">
					<div class="modal-body">
                        ...
                        <div class="input-group mb-4">	           			
							<div class="input-group-append">
		           				<span class="input-group-text" id="basic-addon2">Sélectionner nourriture</span>
		           			</div>
		           			<select id="select" class="form-control" name="idNour" required="">
		           				<option selected="" value="" disabled="">Sélectionner nourriture</option>
                                <?php 
	...
	<div class="modal fade" id="supBtn" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<form action="deleteComNour.php" method="POST">
						<div class="modal-body">
		...
		<div class="row">
		          ...
		          <?php
		          		if (isset($_POST['save'])) {
							...
							$d=$_POST['idNour'];
		          			...
		          			if (!empty($a) AND !empty($d) ) {
					            $req = $bd->prepare('INSERT INTO commandenour (qteComNour,statutComNour,idPv,idNour) VALUES (?,?,?,?)');
		           ...
		           <form action="" method="POST" class="spacer was-validated">
		           		...
		           		<select name="idNour" id="list_nour" class="form-control" required="">
						    <option value="" disabled="" selected="" >Sélectionner la nourriture</option>
						</select><br>
		           		<div class="input-group mb-4">	           			
		           			<input type="text" name="qteComNour" class="form-control" placeholder="Quantite Demandée" required="" autocomplete="off">
	      ...
	      <div class="col-md-9">
	      	<div class="row">
				...
				<a href="../bonCommandeCuis.php"><button class="btn btn-danger btn-lg pull-right" type="button"><span class="fa fa-print"></span> Bon de commande</button></a>
			</div>
	 				...
	 				<table id="tab" class="display table table-bordered table-striped table">
		          	...
		          	<tbody>
		          		<?php
							...
							$req = $bd->query("SELECT A.idComNour,A.qteComNour,date_format(A.dateComNour,'%e-%m-%Y à %T') as dateComNour,designNour FROM commandenour as A,pointvente as B,prodNour as C WHERE A.idNour=C.idNour AND A.idPv=B.idPv AND A.statutComNour = 'commande' ORDER BY idComNour DESC LIMIT $start,$limit");
							
							$res = $bd->query("SELECT count(*) as total FROM commandenour as A,pointvente as B,prodNour as C WHERE A.idNour=C.idNour AND A.idPv=B.idPv AND A.statutComNour = 'commande' LIMIT $start,$limit");
