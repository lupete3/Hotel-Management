...
<body>
	...
	<div class="modal fade" id="editBtn" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form action="upCatEq.php" method="POST" class="was-validated">
	...
	<div class="container-fluid spacer">
		<div class="row">
			<div class="col-md-3">
		          <h3 class="title">AJOUTER CATEGORIE EQUIPEMENT</span></h3>
		          <?php
		          		if (isset($_POST['save'])) {
							  $a=$_POST['designation'];

							  $req=$bd->prepare('SELECT * FROM categorieequip WHERE designation=?');
							  $req->execute(array($a));
							  if ($don=$req->fetch(PDO::FETCH_ASSOC)) {
								...
								<?php
							  	...
							  	$req=$bd->prepare('INSERT INTO categorieequip(designation) VALUES(?)');
		           ...
		           <form action="" method="POST" class="spacer was-validated">
		           		...
		           		<input type="text" name="designation" class="form-control" placeholder="Désignation catégorie" required="" autocomplete="off"><br>
		           		
						<button type="submit" class="btn btn-danger btn-block" name="save">Enregistrer</button>
		           </form>
		    </div>
	      <div class="col-md-9">
	          <h3 class="title">LISTE DES CATEGORIES EQUIPEMENT</span></h3>
	 				...
	 				<table id="tab" class="display table table-bordered table-striped table">
		          	...
		          	<tbody>
		          		<?php
							...
							$req = $bd->query("SELECT * FROM categorieequip LIMIT $start,$limit");
							
							$res = $bd->query('SELECT COUNT(*) as total FROM categorieequip');
	          ...
	          <div class="row">
	          	 <div class="col-3 offset-9">
	          	 	<nav aria-label="Page navigation example">
			    		...
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Previous" href="categorieEquip.php?page=<?php echo $prec;?>">
			    		...
			    		?> 
			    		<li class="page-item <?php echo(($page==$i)?'active':'')?>"><a  class="page-link" href="categorieEquip.php?page=<?php echo $i;?>"><?php echo $i;?></a></li>
			    		<?php
			    		}?>
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Next" href="categorieEquip.php?page=<?php echo $suiv;?>">
