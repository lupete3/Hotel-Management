	...
	<div class="modal fade" id="editBtn" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form action="upComListA.php" method="POST" class="was-validated">
	...
	<div class="container-fluid spacer">
	          ...
	          <?php 
	          			...
	          			switch ($msg) {
	          				...
	          				case 3:
					        	...
					        	<div class="alert alert-danger alert-dismissible" id="msg" role="alert">
									<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
									<h5 class="text-center">Boisson non disponible en stock</h5>
								</div>
	 				...
	 				<table id="tab" class="display table table-bordered table-striped table">
		          	...
		          	<tbody>
		          		<?php
							...
							$req = $bd->query("SELECT A.idCom,A.qteCom,date_format(A.dateCom,'%e-%m-%Y à %T') as dateCom,designBoiss,B.libPv  FROM commande as A,pointvente as B,prodboiss as C WHERE A.idBoiss=C.idBoiss AND A.idPv=B.idPv AND A.statutCom = 'Encours' LIMIT $start,$limit");
							
							$res = $bd->query("SELECT count(*) as total FROM commande as A,pointvente as B,prodboiss as C WHERE A.idBoiss=C.idBoiss AND A.idPv=B.idPv AND A.statutCom = 'Encours'");
	          ...
	          <div class="row">
	          	 <div class="col-3 offset-9">
	          	 	<nav aria-label="Page navigation example">
			    		...
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Previous" href="comListBoissA.php?page=<?php echo $prec;?>">
			    		...
			    		?> 
			    		<li class="page-item <?php echo(($page==$i)?'active':'')?>"><a  class="page-link" href="comListBoissA.php?page=<?php echo $i;?>"><?php echo $i;?></a></li>
			    		<?php
			    		}?>
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Next" href="comListBoissA.php?page=<?php echo $suiv;?>">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form action="upMixComA.php" method="POST">
					<div class="modal-body">
	...
	<div class="modal fade" id="delBtn" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form action="delMixComBoissA.php" method="POST">
					<div class="modal-body">
