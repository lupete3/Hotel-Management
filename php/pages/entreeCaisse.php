	      	...
	      	<div class="row">
				<div class="col-md-5 col-sm-5 col-lg-5 col-xl-5">
					...
					<div class="col-md-5 col-sm-5 col-lg-5 col-xl-5 offset-2" >
						<h4>Disponible : <?php echo number_format($don['montantCaisse'],2); ?> $ </h4>
					</div>
	          	</div>
	 				...
	 				<table id="tab" class="display table table-bordered table-striped table">
		          	...
		          	<tbody>
		          		<?php
							...
							$req = $bd->query("SELECT * FROM entreeCaisse ORDER BY idEntreeCaiss LIMIT $start,$limit");
	          ...
	          <div class="row">
	          	 <div class="col-3 offset-9">
	          	 	<nav aria-label="Page navigation example">
			    		...
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Previous" href="entreeCaisse.php?page=<?php echo $prec;?>">
			    		...
			    		?> 
			    		<li class="page-item <?php echo(($page==$i)?'active':'')?>"><a  class="page-link" href="entreeCaisse.php?page=<?php echo $i;?>"><?php echo $i;?></a></li>
			    		<?php
			    		}?>
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Next" href="entreeCaisse.php?page=<?php echo $suiv;?>">
