	...
	<div class="modal fade" id="editBtn" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form action="upComListDivCuisA.php" method="POST" class="was-validated">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<ul class="navbar-nav ml-auto">
				<li class="nav-item active">
					<a class="nav-link" href="../gestion_commandeA.php"><button type="button" class="btn btn-outline-light connexion"><h3>Retour</h3></button><span class="sr-only">(current)</span></a>
				</li>
			</ul>
	...
	<div class="container-fluid spacer">
		<div class="row">   
	      <div class="col-md-8 offset-2">
	          <h3 class="title">LISTE DE COMMANDES EN COURS DE DIVERS CUISINE</span></h3>
	          <?php 
	 				...
	 				<table id="tab" class="display table table-bordered table-striped table">
		          	...
		          	<tbody>
		          		<?php
							...
							$req = $bd->query("SELECT A.idComCuis,A.qteComDiv,date_format(A.dateComDiv,'%e-%m-%Y à %T') as dateComDiv,B.designDivCuis FROM comcuisine as A,diverscuisine as B WHERE B.idDivCuis=A.idDivCuis AND A.statutComDiv = 'Encours' ORDER BY idComCuis LIMIT $start,$limit");
							
							$res = $bd->query("SELECT count(*) as total FROM comcuisine as A,diverscuisine as B WHERE B.idDivCuis=A.idDivCuis AND A.statutComDiv = 'Encours'");
		          		...
		          		<tr>
								...
								<td>
									<button type="button" class="btn btn-danger supBtn"><span class="fa fa-check"></span>	
									</button>
	          ...
	          <div class="row">
	          	 <div class="col-3 offset-9">
	          	 	<nav aria-label="Page navigation example">
			    		...
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Previous" href="comListDivCuisA.php?page=<?php echo $prec;?>">
			    		...
			    		?> 
			    		<li class="page-item <?php echo(($page==$i)?'active':'')?>"><a  class="page-link" href="comListDivCuisA.php?page=<?php echo $i;?>"><?php echo $i;?></a></li>
			    		<?php
			    		}?>
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Next" href="comListDivCuisA.php?page=<?php echo $suiv;?>">
	...
	<div class="modal fade" id="supBtn" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form action="upMixComDivCuisA.php" method="POST">
					<div class="modal-body">
						<input type="hidden" name="id" id="idCom" required="" autocomplete="off"><br>
		           		<div class="input-group mb-4">	 
	...
	<div class="modal fade" id="delBtn" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form action="delMixComDivCuisA.php" method="POST">
					<div class="modal-body">
