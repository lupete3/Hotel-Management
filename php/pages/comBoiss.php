	...
	<div class="modal fade" id="editBtn" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form action="upCom.php" method="POST" class="was-validated">
	...
	<div class="modal fade" id="supBtn" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<form action="deleteComBoiss.php" method="POST">
						<div class="modal-body">
	 				...
	 				<table id="tab" class="display table table-bordered table-striped table">
		          	...
		          	<tbody>
		          		<?php
							...
							$req = $bd->query("SELECT A.idCom,A.qteCom,date_format(A.dateCom,'%e-%m-%Y à %T') as dateCom,designBoiss FROM commande as A,pointvente as B,prodboiss as C WHERE A.idBoiss=C.idBoiss AND A.idPv=B.idPv AND A.statutCom = 'commande' AND B.idPv='$c' ORDER BY idCom LIMIT $start,$limit");
							
							$res = $bd->query("SELECT count(*) as total FROM commande as A,pointvente as B,prodboiss as C WHERE A.idBoiss=C.idBoiss AND A.idPv=B.idPv AND A.statutCom = 'commande' AND B.idPv='$c'");
	          ...
	          <div class="row">
	          	 <div class="col-3 offset-9">
	          	 	<nav aria-label="Page navigation example">
			    		...
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Previous" href="comBoiss.php?page=<?php echo $prec;?>">
			    		...
			    		?> 
			    		<li class="page-item <?php echo(($page==$i)?'active':'')?>"><a  class="page-link" href="comBoiss.php?page=<?php echo $i;?>"><?php echo $i;?></a></li>
			    		<?php
			    		}?>
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Next" href="comBoiss.php?page=<?php echo $suiv;?>">
