...
<body>
	...
	<div class="modal fade" id="editBtn" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form action="upAvarieNour.php" method="POST" class="was-validated">
                        ...
                        <div class="input-group mb-4">	           			
							<div class="input-group-append">
		           			...
		           			<select id="select" class="form-control" name="idNour" required="">
		           				<option disabled="" selected="" value="">Sélectionner produit</option>
                                <?php 
	...
	<div class="container-fluid spacer">
		<div class="row">
			<div class="col-md-3">
		          <h3 class="title">AJOUTER PRODUIT AVARIE</span></h3>
		          <?php
		          		if (isset($_POST['save'])) {
		          			$a=$_POST['qnteAv'];
		          			$b=$_POST['motif'];
	      ...
	      <div class="col-md-9">
	          <h3 class="title">LISTE DE NOURRITURES AVARIEES</span></h3>
	 				...
	 				<table id="tab" class="display table table-bordered table-striped table">
		          	...
		          	<tbody>
		          		...
		          		<tr>
								...
								<td>
									<a href="approvboiss.php?id=<?php echo $don['idNourAv'] ?> ?>"></a>
	          ...
	          <div class="row">
	          	 <div class="col-3 offset-9">
	          	 	<nav aria-label="Page navigation example">
			    		...
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Previous" href="avarieNour.php?page=<?php echo $prec;?>">
			    		...
			    		?> 
			    		<li class="page-item <?php echo(($page==$i)?'active':'')?>"><a  class="page-link" href="avarieNour.php?page=<?php echo $i;?>"><?php echo $i;?></a></li>
			    		<?php
			    		}?>
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Next" href="avarieNour.php?page=<?php echo $suiv;?>">
