	...
	<div class="modal fade" id="editBtn" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form action="upDivAvar.php" method="POST" class="was-validated">
					<div class="modal-body">
                        ...
                        <div class="input-group mb-4">	           			
							<div class="input-group-append">
		           				<span class="input-group-text" id="basic-addon2">Sélectionner le produit</span>
		           			</div>
		           			<select id="select" class="form-control" name="idDiv" required="">
		           				<option selected="" value="" disabled="">Sélectionner le produit</option>
                                <?php 
	 				...
	 				<table id="tab" class="display table table-bordered table-striped table">
		          	...
		          	<tbody>
		          		<?php
							...
							$req = $bd->query("SELECT A.idDivAvar,A.qteDivAvar,A.motifDivAvar,date_format(A.dateDivAvar,'%e-%m-%Y à %T') as dateDivAvar,A.posteDivAvar, B.designation, B.idDiv FROM avarieDivers as A,stockdivers as B WHERE A.idDiv=B.idDiv AND A.posteDivAvar LIKE '%$c%' ORDER BY A.idDivAvar DESC LIMIT $start,$limit");
							
							$res = $bd->query("SELECT count(*) as total FROM avarieDivers as A,stockdivers as B WHERE A.idDiv=B.idDiv AND A.posteDivAvar LIKE '%$c%' LIMIT $start,$limit");
	          ...
	          <div class="row">
	          	 <div class="col-3 offset-9">
	          	 	<nav aria-label="Page navigation example">
			    		...
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Previous" href="avarieDivers.php?page=<?php echo $prec;?>">
			    		...
			    		?> 
			    		<li class="page-item <?php echo(($page==$i)?'active':'')?>"><a  class="page-link" href="avarieDivers.php?page=<?php echo $i;?>"><?php echo $i;?></a></li>
			    		<?php
			    		}?>
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Next" href="avarieDivers.php?page=<?php echo $suiv;?>">
