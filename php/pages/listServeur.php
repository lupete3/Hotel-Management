	      ...
	      <div class="col-md-12">
	      	<div class="row">
	      		...
	      		<div class="offset-4 col-md-4">
	      			<a href="serveur.php"><button class="btn btn-danger btn-lg pull-right" type="button"><span class="fa fa-plus"></span> Ajouter Serveur</button></a>
	      		</div>
	      	</div>
	 				...
	 				<table id="tab" class="display table table-bordered table-striped table">
		          	...
		          	<tbody>
		          		<?php
							...
							$req = $bd->query("SELECT * FROM serveur LIMIT $start,$limit");
	          ...
	          <div class="row">
	          	 <div class="col-3 offset-9">
	          	 	<nav aria-label="Page navigation example">
			    		...
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Previous" href="listServeur.php?page=<?php echo $prec;?>">
			    		...
			    		?> 
			    		<li class="page-item <?php echo(($page==$i)?'active':'')?>"><a  class="page-link" href="listServeur.php?page=<?php echo $i;?>"><?php echo $i;?></a></li>
			    		<?php
			    		}?>
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Next" href="listServeur.php?page=<?php echo $suiv;?>">
