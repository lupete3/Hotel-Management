            ...
            <div class="row"> 
                ...
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" >
                        ...
                        <center style="padding-top: 30px;">
                             <a href="reception.php" title="Cliquer pour retourner à la page précedente"><img src="../docs/emoticones/icone%20deconnexxion.png" width="50%" alt="Front Office" > </a>
                        </center>
                ...
                <div class="container" style="background-color:white; padding: 20px; border-radius:50px; border : 2px solid #b90112" >                   
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="">
                            <center>
                                 <a href="etatClientPresentC.php" target="_blank" title="Cliquer pour ajouter une Catégorie"><img src="../docs/MAJ/form5.jpg" width="40%" alt="Fiche Boisson" > </a>
                            </center>
                       ...
                       <div class="col-lg-3 col-md-3 col-sm-4 col-xs-3" style="">
                            <center>
                                 <a href="ficheBlancheRC.php" target="_blank"><img src="../docs/emoticones/task6.png" width="40%" alt="Ajout nourriture" > </a>
                            </center>
                       ...
                       <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="">
                            <center>
                                 <a href="ficheAutresRC.php" target="_blank">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="">
                            <center>
                                 <a href="syntheseRecC.php" target="_blank">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 " style="">
                            ...
                            <center>
                                 <a href="rsalle2C.php" target="_blank"><img src="../docs/MAJ/form1.png" width="40%" alt="Rapport" > </a>
                            </center>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 " style="">
                            ...
                            <center>
                                 <a href="previsionnelOccupC.php" target="_blank"><img src="../docs/MAJ/form2.png" width="40%" alt="Rapport" > </a>
                            </center>
                            <legend style="color:black;  text-align:center;">Prévisionnel Occupation</legend>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="">
                            <center>
                                 <a href="clientsPartisC.php" target="_blank">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 " style="">
                            ...
                            <center>
                                 <a href="traitementParChambreC.php" target="_blank"><img src="../docs/MAJ/form4.jpg" width="40%" alt="Rapport" > </a>
                            </center>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="">
                            ...
                            <center>
                                 <a href="grandLivreReceptionC.php" target="_blank"><img src="../docs/MAJ/form7.png" width="40%" alt="Rapport" > </a>
                            </center>
