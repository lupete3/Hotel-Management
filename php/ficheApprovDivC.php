<?php
    ...
    $dateJ=date('Y-m-d');
    $req = $bd->prepare("SELECT date_format(A.dateApprovDiv,'%d-%m-%Y') as dateApprovDiv,A.qnteApprovDiv,A.puApprovDiv,B.designation FROM approvdiv as A,stockdivers as B WHERE  A.dateApprovDiv LIKE '%$dateJ%'");
        $req->execute();
        $req1 = $bd->prepare("SELECT SUM(qnteApprovDiv*puApprovDiv) AS total FROM approvDiv WHERE dateApprovDiv LIKE '%$dateJ%'");
        $req1->execute();
    ...
    if (isset($_GET['save'])) {
        ...
        $req = $bd->prepare("SELECT date_format(A.dateApprovDiv,'%d-%m-%Y') as dateApprovDiv,A.qnteApprovDiv,A.puApprovDiv,B.designation FROM approvdiv as A,stockdivers as B WHERE  A.dateApprovDiv BETWEEN ? AND ?");
        $req->execute(array($in,$out));
        $req1 = $bd->prepare("SELECT SUM(qnteApprovDiv*puApprovDiv) AS total FROM approvDiv WHERE dateApprovDiv BETWEEN ? AND ?");
            ...
            <div class="row" style="border-bottom:1px solid black;margin-bottom:2px">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8" >
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top:70px;">
                        <h1 class="text-center text-uppercase" style="text-align:center; border: 1px solid black">Fiche achat produits divers
                    ...
                    <table class="table table-bordered table-striped spacer">
                        ...
                        <tbody>
                                ...
                                <tr>
                                       ...
                                       <td class="text-right"><?php echo $don['qnteApprovDiv'] ?></td>
                                       <td class="text-right"><?php echo $don['dateApprovDiv'] ?></td>

                                       
                                       <td class="text-right"><?php echo ($don['qnteApprovDiv']*$don['puApprovDiv']) ?></td>
                                        <td></td>
