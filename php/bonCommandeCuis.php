<?php
    ...
    require_once('bd_cnx.php');
        ...
        $req=$bd->query("SELECT A.idComNour,A.qteComNour,date_format(A.dateComNour,'%e-%m-%Y à %T') as dateComNour,designNour,A.idNour FROM commandenour as A,pointvente as B,prodNour as C WHERE A.idNour=C.idNour AND A.idPv=B.idPv AND A.statutComNour = 'commande'");
 ?>
<!DOCTYPE html>
            ...
            <div class="row" style="margin-bottom:10px;  " >
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            while ($don=$req->fetch(PDO::FETCH_ASSOC)) {
                                                $id = $don['idNour'];
                                                 $req2=$bd->query("SELECT qtStockCuis FROM stockcuisine where idNour = '$id'");
                                                 $don1 = $req2->fetch();
                                                ?>
                                                <tr>
                                                    <td><?php echo $num;  ?></td>
                                                    ...
                                                    <td><?php echo $don1['qtStockCuis'] ?></td>
                    ...
                    <div class="container">
                        <div class="row">
                                ...
                                <?php if (isset($_POST['send'])): 
                                    ?>
                                <?php
                                    $req=$bd->query("UPDATE commandenour SET statutComNour='Encours' WHERE statutComNour='commande'"); 
                                    header('location:pages/comNour.php');
                            endif ?>
                                <div class="col-lg-6">
                    ...
                    <div class="col-lg-12" style="">
                             <p style="font-size:1em; font-family:Century Gothic;">Signature chef cuisinier</p> 
                    </div>
            </div>
                    </div>
