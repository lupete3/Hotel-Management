            ...
            <div class="row" style="border-bottom:1px solid black;margin-bottom:2px">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8" >
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top:70px;">
                        <h1 class="text-center" style="text-align:center; border: 1px solid black">Fiche de Réservation par Organisation <?php  ?> </h1>
                    </div>
        ...
        <div class="container">
            <div class="row spacer" >
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 spacer">
                    <h4 class="text-center">Fait à Uvira, le <?php $madate= date('d-m-Y H:i:s'); 
