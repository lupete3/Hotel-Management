            ...
            <div class="col-lg-10" style="margin-top:30px; padding:10px; border: 2px solid #b90112; background-color:white; border-radius:50px;">
                ...
                <div class="row" style=" padding: 20px;" > 
                    ...
                    <div class="col-lg-4" style="">
                        ...
                        <center title="">
                             <a href="pages/avarieNour.php" style="" >
                        ...
                        <legend style="color:grey; text-align:center; border-bottom: 1px solid #b90112">
                            Nourriture Avariée </legend>
                    </div>                    
                    
                    <div class="col-lg-4" style="">
                        
                         <center >
                             <a href="pages/avarieBoiss.php" >
                                <img src="../docs/emoticones/boiss2.png" width="40%" alt="nourriture" > </a>
                        </center>
                        <legend style="color:grey; text-align:center; border-bottom: 1px solid #b90112">Boisson Avariée</legend>
                    </div>                    
                    
                    <div class="col-lg-4" style=" ">
                        
                        <center title="">
                             <a href="pages/avarieDivers.php" style="">
                                <img src="../docs/emoticones/cleaning.png" width="40%" alt="Sauna-Gym-Piscine" > </a>
                        </center>
                        <legend style="color:grey; text-align:center; border-bottom: 1px solid #b90112">Autres produits avariés</legend>
                    </div> 
