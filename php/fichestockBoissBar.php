            ...
            <div class="row" style="border-bottom:1px solid black;margin-bottom:2px">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8" >
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top:70px;">
                        <h3 class="text-center text-uppercase" style="text-align:center; border: 1px solid black">Fiche de stock Boissons/<?php echo $poste; ?></h3>
                    </div>
            ...
            <div class="row spacer" style="" >
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <table class="table table-bordered table-striped table-sm">
                        ...
                        <tbody>
                                <?php
                                $req = $bd->query("SELECT * FROM prodboiss AS A, stockpv AS C,catboiss AS B WHERE B.idCatBoiss=A.idCatBoiss AND  C.idBoiss=A.idBoiss AND C.qtStock >0 AND C.idPv='$c' ORDER BY B.idCatBoiss");
                            ...
                            $num++;
                             ...
                             <tr>
                                ...
                                <td class="text-right"><h4><strong><?php 
                                    $req = $bd->query("SELECT SUM(qtStock*puBoiss) AS total FROM prodboiss AS A, stockpv AS C,catboiss AS B WHERE B.idCatBoiss=A.idCatBoiss AND C.idBoiss=A.idBoiss AND C.idPv='$c'");
