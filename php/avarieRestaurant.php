...
<html>
    ...
    <body id="">
        ...
        <div id="sect1" class="row" style=" background-color:white; padding-top:20px;">
            ...
            <div class="col-lg-12"><h1 style="text-align:center">Produits Avariés</h1></div>
            ...
            <div class="col-lg-10" style="margin-top:30px; padding:20px; border: 2px solid #b90112; background-color:white; border-radius:150px 0px 150px 0px;">
                ...
                <div class="row" style=" padding: 20px;" > 
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4" style="">
                         ...
                         <center >
                             <a href="pages/avarieBoisRest.php" >
                                <img src="../docs/emoticones/boiss2.png" width="40%" alt="nourriture" > </a>
                        </center>
                        <legend style="color:black; text-align:center; border-bottom: 1px solid #b90112">Boisson Avariée</legend>
                    </div>                    
                    
                    <div class="col-lg-4 col-md-4 col-sm-4" style=" ">
                        
                        <center title="">
                             <a href="pages/avariePlat.php" style="">
                                <img src="../docs/emoticones/new/avarieplat.png" width="40%" alt="Sauna-Gym-Piscine" > </a>
                        </center>
                        <legend style="color:black; text-align:center; border-bottom: 1px solid #b90112">Plat avarié</legend>
                    </div> 
                        
                    <div class="col-lg-4 col-md-4 col-sm-4" style=" ">
                        
                        <center title="">
                             <a href="pages/avarieDiversRest.php" style="">
                                <img src="../docs/emoticones/cleaning.png" width="40%" alt="Sauna-Gym-Piscine" > </a>
                        </center>
                        <legend style="color:black; text-align:center; border-bottom: 1px solid #b90112">Autres produits avariés</legend>
                    </div> 
