<?php
    ...
    if (isset($_GET['id'])) {
        ...
        $req=$bd->prepare("SELECT A.idComDiv,A.qteComDiv,date_format(A.dateComDiv,'%e-%m-%Y à %T') as dateComDiv,B.designation FROM comDivers as A,stockdivers as B,service as C WHERE B.idDiv=A.idDiv AND C.id_service=A.id_service AND A.statutComDiv = 'Encours' AND  idComDiv=?");
            ...
            <div class="row" style="margin-bottom:10px;  " >
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                    ...
                    <p style="font-family:Century Gothic; font-size:1.5em; text-align:center; font-weight:bold;">
                        Bon de commande divers N° : <?php echo $id; ?>
                    </p>
