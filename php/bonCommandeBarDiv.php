<?php
    ...
    require_once('bd_cnx.php');
        ...
        $req1=$bd->query("SELECT SUM(qteComDiv*pu) as total FROM comDivers as A,stockdivers as B,service as C WHERE B.idDiv=A.idDiv AND A.statutComDiv = 'commande' AND poste='$c'");
                    ...
                    <div class="container">
                        <div class="row">
                                ...
                                <?php
                                    ...
                                    header('location:pages/comDiv.php');
                            endif ?>
                                <div class="col-lg-6">
