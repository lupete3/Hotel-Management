    ...
    <body id="">
            ...
            <div class="row"> 
                ...
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" >
                        ...
                        <center style="padding-top: 30px;">
                             <a href="ac_sess/ac_rec.php" title="Cliquer pour retourner à la page précedente"><img src="../docs/emoticones/icone%20deconnexxion.png" width="50%" alt="Front Office" > </a>
                        </center>
        ...
        <div id="sect1" class="row">
            ...
            <div class="col-lg-10" style="padding:1%;">
                ...
                <div class="container" style="background-color:white; padding: 20px; border-radius:150px 0px 150px 0px; box-shadow: 0px 10px 20px; border : 2px solid #b90112" >                   
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="">
                            <center>
                                 <a href="etatClientPresent.php" target="_blank" title="Cliquer pour ajouter une Catégorie"><img src="../docs/MAJ/form5.jpg" width="40%" alt="Fiche Boisson" > </a>
                            </center>
                       ...
                       <div class="col-lg-3 col-md-3 col-sm-4 col-xs-3" style="">
                            <center>
                                 <a href="ficheBlancheR.php" target="_blank"><img src="../docs/emoticones/task6.png" width="40%" alt="Ajout nourriture" > </a>
                            </center>
                       ...
                       <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="">
                            <center>
                                 <a href="ficheAutresR.php" target="_blank">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="">
                            <center>
                                 <a href="syntheseRec.php" target="_blank">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 " style="">
                            ...
                            <center>
                                 <a href="rsalle2.php" target="_blank"><img src="../docs/MAJ/form1.png" width="40%" alt="Rapport" > </a>
                            </center>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 " style="">
                            ...
                            <center>
                                 <a href="previsionnelOccup.php" target="_blank"><img src="../docs/MAJ/form2.png" width="40%" alt="Rapport" > </a>
                            </center>
                            <legend style="color:black;  text-align:center;">Prévisionnel Occupation</legend>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="">
                            <center>
                                 <a href="clientsPartis.php" target="_blank">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 " style="">
                            ...
                            <center>
                                 <a href="traitementParChambre.php" target="_blank"><img src="../docs/MAJ/form4.jpg" width="40%" alt="Rapport" > </a>
                            </center>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="">
                            ...
                            <center>
                                 <a href="grandLivreReception.php" target="_blank"><img src="../docs/MAJ/form7.png" width="40%" alt="Rapport" > </a>
                            </center>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style=" ">
                           ...
                           <legend style="color:black; text-align:center;">Historique Réservation</legend>
                        </div> 
