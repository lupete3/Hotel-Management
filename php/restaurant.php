    ...
    <body id="">
        ...
        <div id="sect1" class="row">
            ...
            <div class="col-lg-10" style="padding:1%;">
                ...
                <div class="container" style="background-color:white; padding: 20px; border-radius: 0px 100px 0px 100px; box-shadow: 0px 10px 20px; border : 2px solid #b90112" >                   
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="">
                            <center>
                                 <a href="ficheVentePdvC.php" target="_blank" title="Cliquer pour ajouter une Catégorie"><img src="../docs/emoticones/vin.jpg" width="40%" alt="Fiche Boisson" > </a>
                            </center>
                            <legend style="color:black; text-align:center;">Vente boisson</legend>
                        </div> 
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="">
                            <center>
                                 <a href="ficheAvarieBoissBarC.php" target="_blank"><img src="../docs/emoticones/new/avariealiment.png" width="40%" alt="Ajout nourriture" > </a>
                            </center>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="">
                            <center>
                                 <a href="fichestockBoissBarC.php" target="_blank"><img src="../docs/emoticones/boiss2.png" width="40%" alt="Ajout nourriture" > </a>
                            </center>
                            <legend style="color:black; text-align:center;">stock boisson</legend>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="">
                            <center>
                                 <a href="ficheComBarC.php" target="_blank"><img src="../docs/MAJ/form8.png" width="40%" alt="Ajout nourriture" > </a>
                            </center>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="">
                            <center>
                                 <a href="fichePlatPdvC.php" target="_blank"><img src="../docs/emoticones/new/restaur.png" width="40%" alt="Ajout nourriture" > </a>
                            </center>
                       ...
                       <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="">
                            <center>
                                 <a href="ficheAvarieCuisineC.php" target="_blank"><img src="../docs/emoticones/new/cuis1.png" width="40%" alt="Ajout nourriture" > </a>
                            </center>
                            <legend style="color:black; text-align:center;">Avarie cuisine</legend>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="">
                            <center>
                                 <a href="fichestockNourCuisineC.php" target="_blank"><img src="../docs/emoticones/nour.jpg" width="40%" alt="Ajout nourriture" > </a>
                            </center>
                            <legend style="color:black; text-align:center;">Stock cuisine</legend>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="">
                            <center>
                                 <a href="ficheComCuisineC.php" target="_blank"><img src="../docs/MAJ/form7.png" width="40%" alt="Ajout nourriture" > </a>
                            </center>
