            ...
            <div class="row" style="border-bottom:1px solid black;margin-bottom:2px">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8" >
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top:70px;">
                        <h1 class="text-center text-uppercase" style="text-align:center; border: 1px solid black">Fiche de stock Boissons</h1>
                    </div>
            ...
            <div class="row spacer" >
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <table class="table table-bordered table-striped table-sm">
                        ...
                        <tbody>
                                <?php
                                $req = $bd->query("SELECT * FROM prodboiss AS A INNER JOIN catboiss AS B ON B.idCatBoiss=A.idCatBoiss AND qnteBoiss>0");
                                $num=1;
                            ...
                            <tr>
                                    ...
                                    <td class="text-right"><?php echo ($don['valUnitBoiss']*$don['puBoiss']) ?></td>
                                    <td></td>
                            ...
                            $num++;
                             ...
                             <tr>
                                ...
                                <td class="text-right"><strong><h4><?php 
                                    $req = $bd->query("SELECT SUM(valUnitBoiss*puBoiss) AS total FROM prodboiss");
