    ...
    <body id="">
        ...
        <div id="sect1" class="row">
            ...
            <div class="col-lg-10" style="padding:1%;">
                ...
                <div class="container" style="background-color:white; padding: 30px; border-radius:150px 0px 150px 0px; box-shadow: 0px 10px 20px; border : 2px solid #b90112" >                   
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="">
                            <center>
                                 <a href="menuRC.php" target="_blank" title="Cliquer pour ajouter une Catégorie"><img src="../docs/emoticones/new/book.png" width="40%" alt="Fiche Boisson" > </a>
                            </center>
                       ...
                       <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="">
                            <center>
                                 <a href="ficheBlanche.php" target="_blank"><img src="../docs/emoticones/task6.png" width="40%" alt="Ajout nourriture" > </a>
                            </center>
                       ...
                       <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="">
                            <center>
                                 <a href="ficheAutres.php" target="_blank">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="">
                            ...
                            <center>
                                 <a href="rsalle.php"><img src="../docs/emoticones/task5.jpg" width="40%" alt="Rapport" > </a>
                            </center>
