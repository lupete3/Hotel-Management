    ...
    <body id="">
            ...
            <div class="row"> 
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-7" id="div_lgos">
                    ...
                    <marquee behavior="alternate" >
                        <h1 id="h1_bbh_title" style="font-size: 40px; font-family:century gothic; font-weight: 
                            bold; margin-top: 2px; margin-left: 10px; color: #b90112; padding-top: 3px;
        ...
        <div id="sect1" class="row">
            ...
            <div class="col-lg-10" style="padding:1%;">
                ...
                <div class="container" style="background-color:white; padding: 20px; border-radius:150px 0px 150px 0px; border : 2px solid #b90112" >                   
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="">
                            <center>
                                 <a href="economat.php" title="Cliquer pour ajouter une Catégorie"><img src="../docs/emoticones/task5.jpg" width="40%" alt="Fiche Boisson" > </a>
                            </center>
                       ...
                       <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="">
                            <center>
                                 <a href="reception.php"><img src="../docs/emoticones/task6.png" width="40%" alt="Ajout nourriture" > </a>
                            </center>
                       ...
                       <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style=" ">
                            <center>
                                 <a href="situationFin.php" target="_blank" ><img src="../docs/MAJ/form4.jpg" width="40%" alt="" > </a>
                            </center>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="">
                            ...
                            <center>
                                 <a href="tresorerie.php"><img src="../docs/emoticones/srt.jpg" width="40%" alt="" > </a>
                            </center>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="">
                            ...
                            <center>
                                 <a href="depense.php"><img src="../docs/emoticones/srt5.jpg" width="40%" alt="" > </a>
                            </center>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="">
                            ...
                            <center>
                                 <a href="pages/activiteJournaliere.php"><img src="../docs/MAJ/form7.png" width="40%" alt="" > </a>
                            </center>
                         ...
                         <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="">
                            ...
                            <center>
                                 <a href="ventilation.php" target="_blank"><img src="../docs/MAJ/form6.png" width="40%" alt="" > </a>
                            </center>
