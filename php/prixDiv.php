    ...
    <div class="container-fluid spacer">
        <div class="row">
          <div class="col-md-12">
            <div class="row">
                <div class="col-md-9">
                    <h3 class="text-center">LISTE DES PRIX DE PRODUITS DIVERS
                      <?php 
                            $count = $bd->query('SELECT  COUNT(*) AS nbre  FROM approvdiv as A INNER JOIN stockdivers as B oN B.idDiv=A.idDiv');
              ...
              <div class="row spacer">
                 <div class="col-12">
                    ...
                    <tbody>
                        <?php
                                $req = $bd->query("SELECT designation,puApprovDiv, date_format(A.dateApprovDiv,'%d-%m-%Y') as dateApprovDiv FROM approvdiv as A INNER JOIN stockdivers as B oN B.idDiv=A.idDiv"); 
