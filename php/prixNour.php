        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="prix.php"><button type="button" class="btn btn-outline-light connexion"><h3>Retour</h3></button><span class="sr-only">(current)</span></a>
                </li>
            </ul>
    ...
    <div class="container-fluid spacer">
        <div class="row">
          <div class="col-md-12">
            <div class="row">
                <div class="col-md-9">
                    <h3 class="text-center">LISTE DES PRIX DE NOURRITURES
                      <?php 
                            $count = $bd->query('SELECT  COUNT(*) AS nbre  FROM approvnour as A INNER JOIN prodnour as B oN B.idNour=A.idNour');
              ...
              <div class="row spacer">
                 <div class="col-12">
                    ...
                    <tbody>
                        <?php
                                $req = $bd->query("SELECT designNour,puApprov, date_format(A.dateApprov,'%d-%m-%Y') as dateApprov FROM approvnour as A INNER JOIN prodnour as B oN B.idNour=A.idNour"); 
