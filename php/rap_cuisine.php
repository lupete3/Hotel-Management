            ...
            <div class="row"> 
                ...
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" >
                        ...
                        <center style="padding-top: 30px;">
                             <a href="ac_sess/ac_cuisine.php" title="Cliquer pour retourner à la page précedente !"><img src="../docs/emoticones/icone%20deconnexxion.png" width="50%" alt="Front Office" > </a>
                        </center>
            ...
            <div class="col-lg-10" style="margin-top:30px; padding:10px; border: 2px solid #b90112; background-color:white; border-radius:50px;">
                ...
                <div class="row" style=" padding: 20px;" > 
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3" style="">
                        ...
                        <center title="">
                             <a href="ficheAvarieCuisine.php" target="_blank" style="" >
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3" style=" ">
                        ...
                        <center title="">
                             <a href="fichestockNourCuisine.php" target="_blank" style="">
                                <img src="../docs/emoticones/nour.jpg" width="40%" alt="Sauna-Gym-Piscine" > </a>
                        </center>
                        <legend style="color:grey; text-align:center; border-bottom: 1px solid #b90112">Fiche de stock</legend>
                    </div> 

                    <div class="col-lg-3 col-md-3 col-sm-3" style=" ">
                        
                        <center title="">
                             <a href="ficheComCuisine.php" target="_blank" style="">
                                <img src="../docs/emoticones/cleaning.png" width="40%" alt="Sauna-Gym-Piscine" > </a>
                        </center>
                        <legend style="color:grey; text-align:center; border-bottom: 1px solid #b90112">Fiche des commandes</legend>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-3" style=" ">
                        
                        <center title="">
                             <a href="ficheComCuisineCon.php" target="_blank" style="">
                                <img src="../docs/emoticones/cleaning.png" width="40%" alt="Sauna-Gym-Piscine" > </a>
                        </center>
                        <legend style="color:grey; text-align:center; border-bottom: 1px solid #b90112">Commandes connexes</legend>
                    </div>  
