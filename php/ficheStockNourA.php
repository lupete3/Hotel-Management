            ...
            <div class="row" style="border-bottom:1px solid black;margin-bottom:2px">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8" >
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top:70px;">
                        <h1 class="text-center text-uppercase" style="text-align:center; border: 1px solid black">Fiche de stock nourritures</h1>
                    </div>
            ...
            <div class="row spacer" >
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                                <?php
                                $req = $bd->query("SELECT * FROM prodnour AS A INNER JOIN catnour AS B ON B.idCatNour=A.idCatNour WHERE qnteNour > 0");
                                $num=1;
                            ...
                            <tr>
                                    ...
                                    <td class="text-right"><?php echo $don['qnteNour'] ?></td>
                                    <td class="text-right"><?php echo $don['valUnitNour'].' '.$don['unite'] ?></td>
                                    <td class="text-right"><?php echo $don['puNour'] ?></td>
                                    <td class="text-right"><?php echo ($don['qnteNour']*$don['puNour']) ?></td>
                                    <td></td>
                            ...
                            $num++;
                             ...
                             <tr>
                                ...
                                <td class="text-right"><strong><h4><?php 
                                    $req = $bd->query("SELECT SUM(qnteNour*puNour) AS total FROM prodnour");
