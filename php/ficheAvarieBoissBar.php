...
<?php
    ...
    $poste=isset($_SESSION['profil']['agent5'])?$_SESSION['profil']['agent5']['libPv']:'';
        ...
        $req = $bd->query("SELECT A.idBoissAv,A.qteBoissAv,A.motif,date_format(A.dateBoissAv,'%e-%m-%Y à %T') as dateAv,A.postePvBoiss, B.designBoiss,B.puBoiss, B.idBoiss FROM prodboiss as B,avarieboiss as A WHERE A.idBoiss=B.idBoiss AND  A.dateBoissAv LIKE '%$dateJ%' AND A.postePvBoiss='$poste'");

        $req1 = $bd->query("SELECT SUM(qteBoissAv*puBoiss) AS total FROM avarieboiss as A, prodboiss as B WHERE A.idBoiss = B.idBoiss AND   A.dateBoissAv LIKE '%$dateJ%' AND A.postePvBoiss='$poste'");
            ...
            <div class="row" style="border-bottom:1px solid black;margin-bottom:2px">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8" >
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top:70px;">
                        <h3 class="text-center text-uppercase" style="text-align:center; border: 1px solid black">Fiche Avarie BOISSONS/<?php echo $poste; ?>
                        </h3>
                    </div>
