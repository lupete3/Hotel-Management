<?php
    ...
    $req = $bd->prepare("SELECT B.nomFour,date_format(A.dateApprov,'%d-%m-%Y') as dateApprov,A.qnteApprov,A.puApprov,C.designBoiss FROM approvboiss as A,four as B,prodboiss as C WHERE C.idBoiss=A.idBoiss AND B.idFour=A.idFour AND A.dateApprov Like '%$dateJ%' ");
        $req->execute();
        $req1 = $bd->prepare("SELECT SUM(qnteApprov*puApprov) AS total FROM approvboiss WHERE dateApprov Like '%$dateJ%'");
        $req1->execute();
    ...
    if (isset($_GET['save'])) {
        ...
        $req = $bd->prepare("SELECT B.nomFour,date_format(A.dateApprov,'%d-%m-%Y') as dateApprov,A.qnteApprov,A.puApprov,C.designBoiss FROM approvboiss as A,four as B,prodboiss as C WHERE C.idBoiss=A.idBoiss AND B.idFour=A.idFour AND A.dateApprov BETWEEN ? AND ? ");
        $req->execute(array($in,$out));
        $req1 = $bd->prepare("SELECT SUM(qnteApprov*puApprov) AS total FROM approvboiss WHERE dateApprov BETWEEN ? AND ? ");
            ...
            <div class="row" style="border-bottom:1px solid black;margin-bottom:2px">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8" >
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top:70px;">
                        <h1 class="text-center text-uppercase" style="text-align:center; border: 1px solid black">Fiche achat boissons
                        </h1>
                    ...
                    <table class="table table-bordered table-striped spacer">
                        ...
                        <tbody>
                                ...
                                <tr>
                                        ...
                                        <td><?php echo ($don['qnteApprov']*$don['puApprov']) ?></td>
                                        <td></td>
