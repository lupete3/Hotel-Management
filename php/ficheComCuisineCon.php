            ...
            <div class="row" style="border-bottom:1px solid black;margin-bottom:2px">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8" >
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top:70px;">
                        <h3 class="text-center text-uppercase" style="text-align:center; border: 1px solid black">Liste de commandes journalière connexe </h3>
                    </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                                <?php
                                $dateJ=date('Y-m-d');
                                $req = $bd->query("SELECT A.idComCuis,A.qteComDiv,date_format(A.dateComDiv,'%e-%m-%Y à %T') as dateComDiv,B.designDivCuis,B.prixDivCuis FROM comcuisine as A,diverscuisine as B WHERE B.idDivCuis=A.idDivCuis AND A.statutComDiv = 'Validé' AND dateComDiv LIKE '%$dateJ%' ");
                            ...
                            <tr>
                                    ...
                                    <td><?php echo $don['qteComDiv']* $don['prixDivCuis'] ?></td>
                                    <td></td>
                            ...
                            $num++;
                             ...
                             <tr>
                                <td colspan="5"><strong>Total</strong></td>
                                 <td ><strong>
                                     <?php 
                                        $req1=$bd->query("SELECT SUM(qteComDiv*prixDivCuis) as total FROM comcuisine as A,diverscuisine as B WHERE B.idDivCuis=A.idDivCuis AND A.statutComDiv = 'Validé' AND dateComDiv LIKE '%$dateJ%' ");
