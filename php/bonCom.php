<?php
    ...
    if (isset($_GET['id'])) {
        ...
        $req=$bd->prepare("SELECT A.idCom,A.qteCom,date_format(A.dateCom,'%e-%m-%Y à %T') as dateCom,designBoiss FROM commande as A,pointvente as B,prodboiss as C WHERE A.idBoiss=C.idBoiss AND A.idPv=B.idPv AND A.statutCom = 'Encours' AND  idCom=?");
            ...
            <div class="row" style="margin-bottom:10px;  " >
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                    ...
                    <p style="font-family:Century Gothic; font-size:1.5em; text-align:center; font-weight:bold;">
                        Bon de commande boisson N° : <?php echo $id; ?>
                    </p>
