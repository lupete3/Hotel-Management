            ...
            <div class="row" style="border-bottom:1px solid black;margin-bottom:2px">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8" >
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top:70px;">
                        <h4 class="text-center text-uppercase" style="text-align:center; border: 1px solid black">Liste de transferts journalièrs reçus <?php echo $point; ?> </h4>
                    </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                                ...
                                $req = $bd->query("SELECT * FROM transfert AS A,pointvente AS B,stockpv AS C, prodboiss AS D WHERE C.idPv=B.idPv AND D.idBoiss=C.idBoiss AND B.idPv=A.idPv AND D.idBoiss=A.idStock AND A.dateTrans LIKE '%$dateJ%' AND A.emetteur <> '$point' AND A.idPv= '$idPv' ORDER BY A.idTrans DESC");
                                $num=1;
                            ...
                            $num++;
                             ...
                             <tr>
                                            ...
                                            <td><strong>
                                                <?php 
                                                 $req1=$bd->query("SELECT SUM(A.qte*D.puBoiss) as total FROM transfert AS A,pointvente AS B,stockpv AS C, prodboiss AS D WHERE C.idPv=B.idPv AND D.idBoiss=C.idBoiss AND B.idPv=A.idPv AND D.idBoiss=A.idStock AND A.dateTrans LIKE '%$dateJ%' AND A.emetteur <> '$point' AND A.idPv= '$idPv'");
