	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('Login_v12/images/img-01.jpg');">
			<div class="wrap-login100 p-t-10 p-b-0">
				<form class="login100-form validate-form was-validated" action="php/cnx_brm.php" method="post">
					...
					<div class="wrap-input100 validate-input m-b-10" data-validate = "Username is required"> 
						<input class="input100" type="text" name="username" placeholder="Nom barman" required="" autocomplete="off">
					...
					<div class="wrap-input100 validate-input m-b-10" data-validate = "Category is required">
						<select name="pdv" id="" class="form-control" style="border-radius: 50px; height: 50px; padding-left: 50px; font-weight: bold; color: grey; font-size: bold;" required="">
